...
<p>
  <a href="{% link _resources/diagnosticIntake.md %}" style="color: #0078d4; text-decoration: underline;">How it works →</a>
  <br>
  <a href="{% link _resources/diagnosticIntakeEmail.md %}" style="color: #0078d4; text-decoration: underline;">Example reports →</a>
</p>
